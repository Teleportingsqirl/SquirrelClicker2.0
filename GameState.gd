...
func setup_items():
	all_items = {
		"tapeworm": { "name": "A Tapeworm", "description": "It appears your squirrel was attempting to lose some weight. Gives you an hour of offline earnings instantly, but -20% sps for 30 seconds.", "texture_path": "res://sqrlart/shopart/Sprite-wormshopitem.png", "is_spawnable": true, "type": "powerup" },
		...
		"Clock": { "name": "A Ticking Clock", "description": "It seems this squirrel has swallowed a ticking clock, and potentially developed a taste for human. Gives 2 hours of offline earnings instantly.", "texture_path": "res://sqrlart/shopart/Sprite-clockitem.png", "is_spawnable": true, "type": "powerup" },
	...
	if FileAccess.file_exists(file_path):
		...
		if file:
			...
			if typeof(loaded_data) == TYPE_DICTIONARY:
				...
				var saved_progress = {}; for b in saved_buildings: saved_progress[b.name] = b.owned
				for b in buildings:
